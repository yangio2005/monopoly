...
import CharacterGameBoard from './GameRoom/CharacterGameBoard';
import { GameRoomProvider, useGameRoom } from './GameRoom/GameRoomProvider';

const CharacterGameRoomContent = () => {
    const {
        roomId,
        roomData,
        loading,
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-900 text-cyan-400 font-mono">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="animate-pulse">LOADING CHARACTER ROOM...</div>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0f] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-purple-900/20 via-gray-900 to-black text-gray-100 pt-20 pb-10 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                {/* Header Section with Character Theme */}
                    ...
                    <div className="relative flex flex-col md:flex-row items-center justify-between gap-4">
                        <div className="text-center md:text-left">
                            ...
                            <div className="flex items-center gap-2 mt-2 justify-center md:justify-start">
                                ...
                                <span className="text-xs font-mono text-green-400/80 tracking-widest">CHARACTER MODE • EXPERIMENTAL</span>
                            </div>
                        </div>
                ...
                {/* Main Content - Character Game Board */}
                <div className="mb-6">
                    <CharacterGameBoard />
                </div>
...
const CharacterGameRoomPage = () => (
    <GameRoomProvider>
        <CharacterGameRoomContent />
    </GameRoomProvider>
);

export default CharacterGameRoomPage;
